...
vim.api.nvim_set_keymap('n', '<leader><Tab>1', '1gt', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader><Tab>2', '2gt', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader><Tab>3', '3gt', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader><Tab>4', '4gt', { noremap = true })
